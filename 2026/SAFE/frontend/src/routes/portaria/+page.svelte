                    ...
                    <div class="p-4 border rounded-lg shadow-sm bg-white flex flex-col justify-between border-l-4 border-yellow-400">
                        <div>
                            <div class="flex justify-between items-start mb-2">
                                ...
                                <span class="text-[10px] text-gray-400">{new Date(aut.AUT_time).toLocaleTimeString([], {hour: '2-digit', minute:'2-digit'})}</span>
                            </div>
                    ...
                    <tbody>
                        {#each historico as h}
                            <tr class="border-b hover:bg-gray-50 transition">
                                <td class="p-3 text-gray-500">{new Date(h.updated_at).toLocaleTimeString([], {hour: '2-digit', minute:'2-digit'})}</td>
